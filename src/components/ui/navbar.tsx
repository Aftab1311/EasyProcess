...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full z-50'>
            <div className='w-full text-gray-300 bg-black bg-opacity-90 backdrop-blur-md py-1 hidden md:flex justify-around items-center'>
                <div className='flex justify-start items-center'>
                    <div className='flex justify-start items-center gap-2'>
                        ...
                        <p className='w-1/2 underline text-sm'>A1 Tower, Sohna Road Level 9, Spaze i-Tech Park, Sector 49, Gurugram, Haryana 122018</p>
                        <div className='flex justify-start items-center gap-2'>
            ...
            <div className={`text-black bg-white border-b border-[#D20420] py-3 px-28 flex justify-between items-center flex-wrap bg-opacity-80 backdrop-blur-md ${poppins.className}`}>
                ...
                >
                    ...
                    <Link href="/contact" className='text-center flex justify-center mx-auto my-2 md:mx-0 hidden'>
                ...
                {/* Sponsor Button */}
                <Link href="/contact" className='text-center mx-auto mt-2 md:mx-0 hidden lg:flex'>
