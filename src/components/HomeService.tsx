    ...
    >
      ...
      <div className="relative rounded-lg group shadow-lg md:w-96 h-96 overflow-hidden hover:shadow-2xl mb-10">
        ...
        <div className="w-full h-[120px] group-hover:h-full flex items-center flex-col duration-500 bg-white absolute bottom-0 group-hover:bottom-1/5 left-0">
          ...
          <h3 className="text-3xl text-red-600 font-semibold ml-4 py-4 text-center mt-4 group-hover:mt-20 group-hover:text-xl">
            {title}
          </h3>
          <span className="mx-6 my-2 text-sm  text-center opacity-0 group-hover:opacity-100 transition group-hover:duration-100 group-hover:delay-300">{desc}</span>
